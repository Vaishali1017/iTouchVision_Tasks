...
const CollectionSchedule = ({ collectionDayData }) => {
    return (
        <Container style={{ marginTop: "40px" }}>
            <Typography variant="subtitle1" color="black" fontWeight="bold" gutterBottom>Your Next Collections</Typography> {/* Title */}
                            ...
                            <Card style={{ height: '100%', backgroundColor: day.binColor }}>
                                <CardContent style={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                    <div>
                                        ...
                                        <Typography variant="h5" color="white" fontWeight="bold" style={{ marginBottom: '4rem' }}>
                                            {day.collectionDay}
                                        </Typography>
